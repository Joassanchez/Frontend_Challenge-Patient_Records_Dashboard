...
function StoreInjector({ stores, children }: StoreInjectorProps) {
  ...
  // Snapshot + apply on mount (runs synchronously before paint via useLayoutEffect-like pattern)
 ...
 */
export function withZustandStore(Story: StoryFn, context: { parameters: Record<string, unknown> }) {
