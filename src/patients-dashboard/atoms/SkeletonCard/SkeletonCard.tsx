  ...
  return (
    <div
      ...
      className={cn(
        ...
        'dark:border-slate-700 dark:bg-slate-800 dark:shadow-black/20',
        className,
      )}
    >
      {/* Gradiente shimmer */}
      <div
        className={cn(
          'absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/60 to-transparent dark:via-white/10',
      ...
      <div className="flex gap-2 border-t border-slate-100 pt-3 dark:border-slate-700">
        <div className="h-7 w-16 rounded-full bg-slate-100 dark:bg-slate-700" />
        <div className="h-7 w-20 rounded-full bg-slate-100 dark:bg-slate-700" />
      </div>
    </div>
  );
}
